...
parser.add_argument('--save_dir', type=str, default="saved_model/yelp",
                    help='path to model saving directory')
parser.add_argument('--data_dir', type=str, default="../data/yelp",
                    help='path to data directory')
parser.add_argument('--log_dir', type=str, default="log/yelp",
                    help='path to log directory')
parser.add_argument('--log_file', type=str, default="yelp_hyper_params.txt",
