...
flags.DEFINE_string("save_dir", "saved_model/yelp", "path to data dir")
flags.DEFINE_string("data_dir", "data/yelp", "path to data dir")

flags.DEFINE_string("para_log_dir", "log", "directory for saving log")
flags.DEFINE_string("log_file", "yelp_pretrain_hyper_params.txt", "directory for saving log")
