...
flags.DEFINE_string("train", "pseudo_train", "path to train data")
...
flags.DEFINE_string("log_file", "imdb_pretrain_hyper_params.txt", "directory for saving log")
...
flags.DEFINE_float("gamma_negative", -0.2, "")

flags.DEFINE_string("reg_type", "pairwise", "regularization type")

flags.DEFINE_integer("num_epochs", 2, "maximum number of epochs")
...
flags.DEFINE_integer("eval_period", 50, "evaluate on dev every period")
...
flags.DEFINE_boolean("unsupervised", False, "whether to use unsupervised method")
